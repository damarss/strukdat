...
void main() {
    ...
    n = head;
    printf("\nIsi linked list setelah penambahan head: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("\nIsi linked list setelah penambahan tail: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("\nIsi linked list setelah penambahan value di tengah: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("\nIsi linked list setelah node head dihapus: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("\nIsi linked list setelah node tail dihapus: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("\nIsi linked list setelah node yang ada di tengah dihapus: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
    ...
    n = head;
    printf("Isi linked list setelah dihapus secara keseluruhan: \n");
    while (n != NULL) {
        printf("%d\n", n->value);
        n = n->next;
    };
